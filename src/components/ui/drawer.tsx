...
>(({ className, children, showCloseButton = true, direction = 'bottom', ...props }, ref) => {
  const directionClasses = {
    right: "fixed inset-y-0 right-0 z-50 h-full w-full border-l bg-background sm:w-[600px] flex flex-col",
    left: "fixed inset-y-0 left-0 z-50 h-full w-full border-r bg-background sm:w-[600px] flex flex-col",
  ...
  // Para drawers laterales, necesitamos usar un enfoque diferente
      ...
      <DrawerPortal>
        ...
        <DrawerPrimitive.Content
          ...
          className={cn(
            ...
            "data-[vaul-drawer-direction=right]:animate-in data-[vaul-drawer-direction=right]:slide-in-from-right data-[vaul-drawer-direction=left]:animate-in data-[vaul-drawer-direction=left]:slide-in-from-left",
            className
          )}
          {...props}
        >
