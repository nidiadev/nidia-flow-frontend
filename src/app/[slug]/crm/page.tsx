...
import { QueryLoading, LoadingSpinner, CardSkeleton, LoadingButton, StatsCardSkeleton, ListSkeleton } from '@/components/ui/loading';
  ...
  return (
    <ErrorBoundary>
      <div>
        <PageHeader
          title="CRM"
          description="Gestiona tus clientes, leads y pipeline de ventas"
          variant="gradient"
          actions={
            isOffline && (
