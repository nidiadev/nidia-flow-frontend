  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold font-outfit mb-2 bg-gradient-to-r from-nidia-green to-nidia-purple bg-clip-text text-transparent">Tareas</h1>
          <p className="text-muted-foreground">
            Gestiona y programa tareas operativas
          </p>
        </div>
        <Button>
